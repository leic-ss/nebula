...
#ifndef META_HTTP_METAHTTPCLUSTEINFOHANDLER_H
#define META_HTTP_METAHTTPCLUSTEINFOHANDLER_H
 ...
 *
 */
class MetaHttpClusterInfoHandler : public proxygen::RequestHandler {

 public:
 MetaHttpClusterInfoHandler() = default;
